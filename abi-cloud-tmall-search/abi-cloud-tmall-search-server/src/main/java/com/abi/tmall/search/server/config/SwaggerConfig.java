...
public class SwaggerConfig {
    ...
    public Docket docket(Environment environment) {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .enable(flag)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.abi.tmall.search.server.controller"))
                .build();
    }
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("abi-cloud-tmall-elasticsearch接口文档")
                .description("abi-cloud-tmall-elasticsearch接口文档")
                .termsOfServiceUrl("")
                .contact(new Contact("", "", ""))
                .version("1.0")
                .build();
