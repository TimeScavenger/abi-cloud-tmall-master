package com.abi.tmall.search.test.atguigu;

import com.abi.base.foundation.utils.JacksonUtils;
import com.abi.tmall.search.server.TmallSearchServerApplication;
...
@SpringBootTest(classes = TmallSearchServerApplication.class)
class MallSearchTest {
    ...
    public void searchData() throws IOException {
        ...
        for (SearchHit hit : searchHits) {
            ...
            System.out.println("命中数据：" + jsonString);
            // 可以通过 json 转换成实体类对象
            Bank bank = JacksonUtils.toBean(jsonString, Bank.class);
            System.out.println("转换成Java对象：" + bank);
        }
